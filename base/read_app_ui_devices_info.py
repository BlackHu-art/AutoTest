...
class Read_APP_UI_Devices_Info(object):
    ...
    def _read_devices_info(self, filepath):
        ...
        get_system_auth_alert_label = lambda tmp_system_auth_alert_label: list(
            filter(None, tmp_system_auth_alert_label.split('&&'))) if tmp_system_auth_alert_label else []
        for tmp_system_auth_alert_label in get_lambda(
        ...
        devices_info.is_enable_system_auth_check = get_lambda(
